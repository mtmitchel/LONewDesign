...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::tasks::create::create_task,
            commands::tasks::update::update_task_command,
            commands::tasks::delete::delete_task,
            commands::tasks::read::get_tasks,
            commands::tasks::lists::get_task_lists,
            commands::tasks::lists::create_task_list,
            commands::tasks::lists::delete_task_list,
            commands::tasks::task_move::queue_move_task,
