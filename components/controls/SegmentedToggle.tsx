          ...
          return (
            <ToggleGroupPrimitive.Item
              ...
              className={cn(
                ...
                'text-[length:var(--text-sm)] font-[var(--font-weight-medium)] text-[var(--control-text-muted)]',
                'transition-[color,background,transform] motion-safe:duration-[var(--duration-quick)] motion-safe:ease-[var(--easing-standard)]',
                'hover:bg-[var(--control-segment-bg)] hover:text-[var(--control-text)]',
                'data-[state=on]:text-[var(--control-text)]',
