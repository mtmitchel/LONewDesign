      ...
      <TriPane
        ...
        left={
          leftPaneVisible ? (
            ...
            <div className="h-full w-5 min-w-[20px] max-w-[20px] bg-[var(--bg-surface-elevated)] shadow-[1px_0_0_var(--border-subtle)] flex items-center justify-center">
              <PaneCaret
                side="left"
                label="Show notes sidebar"
                ariaKeyshortcuts="]"
