...
export function WeatherWidget({ widget }: WidgetProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      {/* Location */}
      <div className="text-sm text-[var(--text-secondary)] mb-3 truncate">
        {location}
      </div>
      ...
      <div className="flex items-center gap-4 mb-4">
        <div className="flex-shrink-0">
          <CurrentIcon size={48} className="text-[var(--primary)]" />
        </div>
        <div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        ...
        <div className="flex items-center gap-2">
          <Droplets size={14} className="text-[var(--text-secondary)]" />
          <span className="text-xs text-[var(--text-secondary)]">
            ...
            {mockWeatherData.forecast.map((day, index) => {
              ...
              return (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <DayIcon size={16} className="text-[var(--text-secondary)]" />
